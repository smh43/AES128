...
const vector<vector<uint8_t>> AES128::unSubBytes = 
{
...
const vector<uint8_t> AES128::Rcon = 
{        
    0x00, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, // de base c'est des colonnes de 4, mais vu que seul le premier élément n'est pas 0, on garde que celui la
